...
\begin{align*}
	p(s) = p(a_0,a_1,...,a_{n-1})p(\text{stop})
\end{align*}
...
\begin{align*}
	p(a_0, a_1, ..., a_{n-1}) = \prod_{i=0}^{n-1}p(\delta(r_i, a_i))
\end{align*}
...
\begin{align*}
	p(\delta(r_i, a_i)) &= \frac{1}{\sum_{a\in A} 1\{\delta(r_i, a)\in Q\}}
\end{align*}
